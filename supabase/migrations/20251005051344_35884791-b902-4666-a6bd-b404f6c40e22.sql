...
DROP POLICY IF EXISTS "Anyone can view provider specialties" ON public.provider_specialties;
DROP POLICY IF EXISTS "Providers can insert own specialties" ON public.provider_specialties;
DROP POLICY IF EXISTS "Providers can update own specialties" ON public.provider_specialties;
DROP POLICY IF EXISTS "Providers can delete own specialties" ON public.provider_specialties;
