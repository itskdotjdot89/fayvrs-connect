...
import { markOnboardingComplete, trackOnboardingProgress } from "@/utils/onboardingHelper";
...
export default function Onboarding() {
  ...
  const handleCarouselChange = (carouselApi: CarouselApi) => {
    ...
    trackOnboardingProgress(carouselApi.selectedScrollSnap());
    
    carouselApi.on("select", () => {
      const slideIndex = carouselApi.selectedScrollSnap();
      setCurrent(slideIndex);
      trackOnboardingProgress(slideIndex);
    });
  };
